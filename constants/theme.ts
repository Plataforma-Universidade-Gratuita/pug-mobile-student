...
const lightTheme: AppResolvedTheme = {
	...
	colors: {
		...
		tabFgActive: "#9b2234",
		tabFgInactive: "#7c8290",
		tabBgActive: "rgba(155, 34, 52, 0.08)",
		tabBgPressed: "rgba(155, 34, 52, 0.12)",
		tabSeparator: "#d8dde4",
	},
	radius,
	space,
...
const darkTheme: AppResolvedTheme = {
	...
	colors: {
		...
		tabFgActive: "#f2d0d6",
		tabFgInactive: "#8e8a95",
		tabBgActive: "rgba(255, 255, 255, 0.05)",
		tabBgPressed: "rgba(255, 255, 255, 0.08)",
		tabSeparator: "rgba(255, 255, 255, 0.08)",
	},
	radius,
	space,
	type,
